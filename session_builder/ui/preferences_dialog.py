...
class PreferencesDialog(QDialog):
    def __init__(self, prefs: Preferences, parent=None):
        ...
        if self._amp_mode == "dB":
            from session_builder.utils.amp_utils import amplitude_to_db, MIN_DB
    ...
    def _on_amp_mode_change(self, mode: str):
        ...
        from session_builder.utils.amp_utils import db_to_amplitude, amplitude_to_db, MIN_DB
    ...
    def convert_amplitudes_to_db(self):
        ...
        from session_builder.utils.amp_utils import amplitude_to_db, is_amp_key
    ...
    def open_voice_detail_display_dialog(self):
        from session_builder.ui.voice_detail_display_dialog import VoiceDetailDisplayDialog
    ...
    def get_preferences(self) -> Preferences:
        from session_builder.utils.amp_utils import db_to_amplitude
