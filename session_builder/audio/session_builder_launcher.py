...
from session_builder.audio.session_model import (
    Session,
    SessionStep,
...
def launch_session_builder(
    ...
    *,
    ...
    try:
        from session_builder.ui import themes
        from session_builder.ui.session_builder_window import SessionBuilderWindow
